...
<body class=" "style= "background: rgb(183,179,242);
background: linear-gradient(185deg, rgba(183,179,242,1) 24%, rgba(222,94,233,0.8743872549019608) 64%, rgba(106,198,217,1) 91%);">
	<div class="container">
					...
					<div class="card-body p-0">
						...
						<div class="p-5">
							<div class="text-center">
								<h4 class="h4 text-gray-900 mb-4"><b>Login POS kasirr</b></h4>
							</div>
