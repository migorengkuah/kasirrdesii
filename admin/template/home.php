...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header "style="background: rgb(183,179,242);
background: linear-gradient(90deg, rgba(183,179,242,1) 18%, rgba(222,94,233,0.8743872549019608) 54%, rgba(106,198,217,1) 100%);" text-white">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header "style="background: rgb(183,179,242);
background: linear-gradient(135deg, rgba(183,179,242,1) 24%, rgba(222,94,233,0.8743872549019608) 64%, rgba(106,198,217,1) 91%); text-white;">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header "style=" background: rgb(183,179,242);
background: linear-gradient(239deg, rgba(183,179,242,1) 17%, rgba(222,94,233,0.8743872549019608) 58%, rgba(106,198,217,1) 90%, rgba(37,218,255,0.7483368347338936) 95%); text-black;">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header "style=" background: rgb(183,179,242);
background: linear-gradient(135deg, rgba(183,179,242,1) 24%, rgba(222,94,233,0.8743872549019608) 64%, rgba(106,198,217,1) 91%); text-white">
                <h6 class="pt-2"><i class="fa fa-table"></i> Kategori Barang</h6>
            </div>
            <div class="card-body">
                <center>
