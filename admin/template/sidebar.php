...
?>
<!-- Sidebar -->
<ul class="navbar-nav -success sidebar sidebar-white accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">POS Kasirr<sup></sup></div>
    </a>
...
<?php if(!empty($_SESSION['admin']) && $_SESSION['admin']['id_member'] == '1'){?>
    <div>
        <li class="nav-item active">
            <a class="nav-link" href="register.php">
                <i style="color:dark" class="fas fa-fw fa fa-user"></i>
                    <span style="color:dark">Register</span></a>
</li>
</div>
<?php }?>
