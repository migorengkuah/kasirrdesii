						...
						<tr>
							...
							<td>
								...
								<a href="index.php?page=laporan" class="btn btn-success">
									<i class="fa fa-hourglass-half"></i> Refresh</a>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table table-bordered w-100 table-sm" id="example1">
						<thead>
							<tr style="background:#b7b3f2;color:#333;">
								<th> No</th>
								<th> ID Barang</th>
								<th> Nama Barang</th>
						...
						<tfoot>
							<tr>
								...
								<th style="background:#00FF7F;color:#fff;">Keuntungan</th>
								<th style="background:#00FF7F;color:#fff;">
